                        ...
                        <Box className="order_main_box">
                                ...
                                {ele.map((item) => {
                                    ...
                                    return (
                                        <Box className="ordersName_price">
                                            <img className="orderDishImg" src={`/imagesfurnis/kitchen.svg`} alt="" />
                            ...
                            <Box className="total_price_box black_solid">
                                <Box className="boxTotal">
                                    ...
                                    <Button
                                        variant="contained" sx={{ mx: "25px" }} style={{ borderRadius: "10px" }} color="primary">Cancel</Button>
                                    <Button
                                        variant="contained" style={{ borderRadius: "10px" }} color="secondary">Pay</Button>
